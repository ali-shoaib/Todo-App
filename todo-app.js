import React, { Component } from 'react';
  ...
  return (  
    <div className="container" style={this.css}>
      <h1 style={this.css2}>Todo App</h1>
      <div className="jumbotron ">
      <div className="form-group">
      <label htmlFor="usr">Name:</label>
      <input type="text" className="form-control" id="usr" onChange={e => this.updateInput("newItem",e.target.value)} value={this.state.newItem}/>
      </div>
